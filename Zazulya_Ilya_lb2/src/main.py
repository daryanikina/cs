...
def func_horizontal(img, i, count_l, curr_height, w, h, N):
...
def func_vertical(img, i, count_l, curr_width, w, h, N):
...
def invert(img, N, vertical):
    ...
    if vertical:
        ...
        for i in range(count_l):
            if w % N != 0 and i == count_l - 1:
                if i % 2 == 1:
                    func_vertical(img, i, count_l, curr_width, w, h, N)
            elif i % 2 == 1:
                func_vertical(img, i, count_l, curr_width, w, h, N)
            if curr_width + N <= w:
                curr_width += N
        ...
        for i in range(count_l):
            if h % N != 0 and i == count_l - 1:
                if i % 2 == 1:
                    func_horizontal(img, i, count_l, curr_height, w, h, N)
            elif i % 2 == 1:
                func_horizontal(img, i, count_l, curr_height, w, h, N)
            if curr_height + N <= h:
                curr_height += N
